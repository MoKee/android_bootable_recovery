...
#include <applypatch-mokee/imgpatch.h>
...
#include <applypatch-mokee/imgdiff.h>
...
int ApplyImagePatch(const unsigned char* old_data, size_t old_size, const unsigned char* patch_data,
  ...
  Value patch(Value::Type::BLOB, std::string(reinterpret_cast<const char*>(patch_data), patch_size));
