...
#ifndef _OTAUTIL_MOKEE_OTAUTIL_MOKEE_CACHE_LOCATION_H_
#define _OTAUTIL_MOKEE_OTAUTIL_MOKEE_CACHE_LOCATION_H_
...
#endif  // _OTAUTIL_MOKEE_OTAUTIL_MOKEE_CACHE_LOCATION_H_
